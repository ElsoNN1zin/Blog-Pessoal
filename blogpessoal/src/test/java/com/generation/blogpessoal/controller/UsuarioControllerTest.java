...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		ResponseEntity<Usuario> corpoResposta = testRestTemplate.exchange("/usuario/cadastrar", HttpMethod.POST, corpoRequisicao, Usuario.class); 
	...
	@Test
	@DisplayName("Listar todos oss Usuários")
	public void deveMostrarTodosUsuarios() {
		...
		ResponseEntity<String> resposta = testRestTemplate.withBasicAuth("root@root.com", "rootroot").exchange("/usuarios/atualizar", HttpMethod.GET, null, String.class);
